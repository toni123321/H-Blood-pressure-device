...
//					j+=50;
		...
		aADCxConvertedData[0] = HAL_ADC_GetValue(&AdcHandle);
		battery_voltage = ((aADCxConvertedData[0] * 3.3) / 4095) * 1.41;

		high_battery = 4.2 - (battery_voltage * 25/100);
		medium_battery = 4.2 - (battery_voltage * 50/100);
		low_battery = 4.2 - (battery_voltage * 75/100);
