...
void GPIO_Init()
{
	...
	GPIO_LED_Struct.Pull  = GPIO_PULLUP;
	GPIO_LED_Struct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;

	GPIO_LED_Struct.Pin = LED2_PIN;
	HAL_GPIO_Init(LED2_GPIO_PORT, &GPIO_LED_Struct);
